...
def 更改参数的转换(block):
    ...
    if name in ['setFillStyle','setStrokeStyle']:
        ...
        if name == 'drawImage':
            ...
            block.update({"mutation": { "tagName": "mutation", "children": [], "proccode": "妙笔. cvsImage. drawImage %s %s %s", "argumentids": "[\"raphael.cvsImage.fun.drawImage.inputs.image\",\"raphael.cvsImage.fun.drawImage.inputs.x\",\"raphael.cvsImage.fun.drawImage.inputs.y\"]", "warp": "false", "global": "true", "return": "false" }})
        else:
            block.update({"mutation": { "tagName": "mutation", "children": [], "proccode": "妙笔. cvsImage. loadImage %s", "argumentids": "[\"raphael.cvsImage.fun.loadImage.inputs.image\"]", "warp": "false", "global": "true", "return": "false" }})
